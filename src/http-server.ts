...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Get a specific Konkurrensverket decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search Konkurrensverket merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "List all sectors with Konkurrensverket enforcement activity, including decision and merger counts.",
